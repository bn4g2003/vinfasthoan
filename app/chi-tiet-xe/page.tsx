...
export default function CarDetail() {
  ...
  const colors = [
    { name: "Màu 1", colorCode: "#d1d5db", img: "/chi tiết xe/xe theo mau/imgi_4_z5423562096141_871c1d73895398d6b5d4d60c867d9a0b.jpg" },
    { name: "Màu 2", colorCode: "#fbbf24", img: "/chi tiết xe/xe theo mau/imgi_5_z5423562165419_948c075aa982cd110626688de87c9f68.jpg" },
    { name: "Màu 3", colorCode: "#3b82f6", img: "/chi tiết xe/xe theo mau/imgi_6_z5423562243183_bc4148cc0bb9acb826d7abe1fa74db35.jpg" },
    { name: "Màu 4", colorCode: "#ef4444", img: "/chi tiết xe/xe theo mau/imgi_7_z5423562300196_9b777c05a020319605b62865af825da0.jpg" },
    { name: "Màu 5", colorCode: "#10b981", img: "/chi tiết xe/xe theo mau/imgi_8_z5423562357955_5fdc0704fbad757500732964a52dcef5.jpg" },
    { name: "Màu 6", colorCode: "#000000", img: "/chi tiết xe/xe theo mau/imgi_9_z5423562408713_be40faf3fa462604776bdf717bd7c52c.jpg" },
  ];
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
      ...
      <main className="max-w-[1200px] mx-auto px-4 py-16">
        ...
        <div className="text-sm text-gray-500 mb-8 uppercase tracking-widest font-bold">
            ...
            <span className="text-black">VINFAST VF 3</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div className="border border-gray-200 p-4">
            <img src={colors[selectedColor].img} alt="Xe VinFast VF 3" className="w-full h-auto object-contain" />
          ...
          <div>
            <h1 className="text-4xl font-bold uppercase mb-4 text-black">VINFAST VF 3</h1>
            <div className="w-16 h-[2px] bg-[#c8102e] mb-6"></div>
            <p className="text-2xl font-bold text-[#c8102e] mb-6">Giá từ: 235.000.000 VNĐ</p>
            <p className="text-gray-800 mb-8 text-lg leading-relaxed">
              Mẫu xe điện cỡ nhỏ tiên phong của VinFast mang đậm cá tính, thiết kế năng động và cực kỳ tiện dụng. Với ngoại hình mạnh mẽ cùng khả năng di chuyển linh hoạt trong đô thị, VF 3 hứa hẹn sẽ trở thành mẫu xe quốc dân mới của người Việt.
            </p>
        ...
        <div className="mt-24">
          ...
          <div className="space-y-8">
             <img src="/chi tiết xe/chi tiết xe/imgi_12_vf3-1.jpg" className="w-full max-w-4xl mx-auto border border-gray-200 shadow-sm" />
             <img src="/chi tiết xe/chi tiết xe/imgi_13_vf3-2.jpg" className="w-full max-w-4xl mx-auto border border-gray-200 shadow-sm" />
             <img src="/chi tiết xe/chi tiết xe/imgi_14_vf3-3.jpg" className="w-full max-w-4xl mx-auto border border-gray-200 shadow-sm" />
          </div>
        </div>
        ...
        <div className="mt-24 mb-10">
          ...
          <div className="space-y-8">
             <img src="/chi tiết xe/thông số xe/imgi_19_TSKT-VF-3-3-scaled.jpg" className="w-full max-w-5xl mx-auto border border-gray-200 shadow-sm" />
          </div>
        </div>
      </main>
        ...
        <div className="max-w-[1200px] mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-y-3 gap-x-4 text-[15px]">
              {['VF 3', 'VF 5', 'VF 6', 'VF 7', 'VF 8', 'VF 9', 'VinFast Minio', 'VinFast Herio', 'VinFast Nerio', 'VinFast Limo'].map((car) => (
          ...
          <div className="bg-white p-8 max-w-md w-full relative shadow-2xl border-t-4 border-[#c8102e]">
            ...
            <form className="space-y-4 text-left">
              ...
              <div>
                ...
                <textarea className="w-full border border-gray-300 p-2.5 text-[15px] h-24 focus:border-[#c8102e] focus:outline-none" placeholder="Dòng xe bạn đang quan tâm..."></textarea>
              </div>
